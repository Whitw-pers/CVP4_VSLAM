function camPoses = getGroundTruth(fileName, imds)
% Import ground truth camera poses from a .txt file
% code copied from 'vision/MonocularVisualSimultaneousLocalizationAndMappingExample'
